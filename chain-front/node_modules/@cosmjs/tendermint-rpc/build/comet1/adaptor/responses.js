...
const jsonchecks_1 = require("../../jsonchecks");
...
function decodeConsensusParams(data) {
    return {
        block: data.block ? decodeBlockParams((0, jsonchecks_1.jCheckObject)(data.block)) : undefined,
        evidence: data.evidence ? decodeEvidenceParams((0, jsonchecks_1.jCheckObject)(data.evidence)) : undefined,
    };
}
...
function decodeGenesis(data) {
    return {
        ...
        appHash: (0, encoding_1.fromHex)((0, jsonchecks_1.jCheckSet)(data.app_hash)), // empty string in kvstore app
...
function decodeNodeInfo(data) {
    return {
        ...
        version: (0, jsonchecks_1.jCheckString)(data.version), // Can be empty (https://github.com/cosmos/cosmos-sdk/issues/7963)
        channels: (0, jsonchecks_1.jCheckString)(data.channels), // can be empty
