...
export declare const QueryChannelResponse: {
    ...
    fromPartial<I extends {
        channel?: {
            ...
            upgradeSequence?: bigint | undefined;
        } | undefined;
...
export declare const QueryNextSequenceSendRequest: {
    ...
    fromPartial<I extends {
        ...
        portId?: string | undefined;
        channelId?: string | undefined;
    } & Record<Exclude<keyof I, keyof QueryNextSequenceSendRequest>, never>>(object: I): QueryNextSequenceSendRequest;
};
export declare const QueryNextSequenceSendResponse: {
    ...
    } & Record<Exclude<keyof I, keyof QueryNextSequenceSendResponse>, never>>(object: I): QueryNextSequenceSendResponse;
};
export declare const QueryUpgradeErrorRequest: {
    ...
    fromPartial<I extends {
        ...
        portId?: string | undefined;
        channelId?: string | undefined;
    } & Record<Exclude<keyof I, keyof QueryUpgradeErrorRequest>, never>>(object: I): QueryUpgradeErrorRequest;
};
export declare const QueryUpgradeErrorResponse: {
    ...
    fromPartial<I extends {
        ...
        errorReceipt?: ({
            ...
            sequence?: bigint | undefined;
            message?: string | undefined;
        } & Record<Exclude<keyof I["errorReceipt"], keyof ErrorReceipt>, never>) | undefined;
        proof?: Uint8Array | undefined;
        proofHeight?: ({
            revisionNumber?: bigint | undefined;
            revisionHeight?: bigint | undefined;
    ...
    } & Record<Exclude<keyof I, keyof QueryUpgradeErrorResponse>, never>>(object: I): QueryUpgradeErrorResponse;
};
export declare const QueryUpgradeRequest: {
    ...
    fromPartial<I extends {
        ...
        portId?: string | undefined;
        channelId?: string | undefined;
    } & Record<Exclude<keyof I, keyof QueryUpgradeRequest>, never>>(object: I): QueryUpgradeRequest;
};
export declare const QueryUpgradeResponse: {
    ...
    fromPartial<I extends {
        ...
        upgrade?: ({
            ...
            fields?: ({
                ...
                ordering?: import("./channel").Order | undefined;
                connectionHops?: (string[] & string[] & Record<Exclude<keyof I["upgrade"]["fields"]["connectionHops"], keyof string[]>, never>) | undefined;
                version?: string | undefined;
            } & Record<Exclude<keyof I["upgrade"]["fields"], keyof import("./upgrade").UpgradeFields>, never>) | undefined;
            timeout?: ({
                height?: {
                    revisionNumber?: bigint | undefined;
                    revisionHeight?: bigint | undefined;
                ...
                height?: ({
                    ...
                    revisionNumber?: bigint | undefined;
                    revisionHeight?: bigint | undefined;
                } & Record<Exclude<keyof I["upgrade"]["timeout"]["height"], keyof Height>, never>) | undefined;
                timestamp?: bigint | undefined;
            } & Record<Exclude<keyof I["upgrade"]["timeout"], keyof import("./channel").Timeout>, never>) | undefined;
            nextSequenceSend?: bigint | undefined;
        } & Record<Exclude<keyof I["upgrade"], keyof Upgrade>, never>) | undefined;
        proof?: Uint8Array | undefined;
        proofHeight?: ({
            revisionNumber?: bigint | undefined;
            revisionHeight?: bigint | undefined;
    ...
    } & Record<Exclude<keyof I, keyof QueryUpgradeResponse>, never>>(object: I): QueryUpgradeResponse;
};
export declare const QueryChannelParamsRequest: {
    ...
    fromPartial<I extends {} & {} & Record<Exclude<keyof I, never>, never>>(_: I): QueryChannelParamsRequest;
};
export declare const QueryChannelParamsResponse: {
    ...
    } & Record<Exclude<keyof I, "params">, never>>(object: I): QueryChannelParamsResponse;
};
